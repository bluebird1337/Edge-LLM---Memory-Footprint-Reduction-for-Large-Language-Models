...
api_key = "OPENAI_API_BOGUS_KEY"                       # Required, use bogus string for Llama.cpp
api_base = "http://localhost:8000/v1"            # Use API endpoint or comment out for OpenAI
agentname = "Jarvis"                             # Set the name of your bot
mymodel  = "llama2-oasst1-1k_merged.gguf"                              # Pick model to use e.g. gpt-3.5-turbo for OpenAI
TESTMODE = False                                 # Uses test prompts
USE_SYSTEM = True                               # Use system prompt for first message
